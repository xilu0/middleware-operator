...
import (
	...
	databasescontroller "github.com/xilu0/middleware-operator/controllers/databases"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:   "db8e4c6a.wise2c.com",
	})
	if err != nil {
	...
	if err = (&databasescontroller.RedisReconciler{
		Client: mgr.GetClient(),
