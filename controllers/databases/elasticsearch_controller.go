...
// +kubebuilder:rbac:groups=databases.wise2c.com,resources=elasticsearches,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=databases.wise2c.com,resources=elasticsearches/status,verbs=get;update;patch
